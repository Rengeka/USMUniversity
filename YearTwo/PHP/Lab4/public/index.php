...
require_once __DIR__ . '/../src/services/post.service.php';
...
<body class="bg-gray-100 min-h-screen">
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div class="text-center mt-8">
            <a href="?page=<?= $page + 1 ?>" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">
                Next page
            </a>
        </div>
    </div>

    <a href="create.post.php" id="add-post-btn" class="fixed bottom-8 right-8 p-4 bg-blue-500 text-white rounded-full shadow-lg hover:bg-blue-600 transition-colors duration-200">
