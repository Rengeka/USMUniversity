...
def run_all():
    ...
    print("Path:", path)
    print("Solution length:", len(path) - 1 if path else None)
    print("Visited vertices:", visited)
    print("Generated states:", generated)
    print("Branching factor:", round(b, 2))
    print("Time:", f"{t:.6f} s")
    print()
    
    print("Forward greedy with heuristic")
    ...
    print("Backward greedy with heuristic")
